      ...
      <table width="710" height="45" border="0" align="center" cellpadding="2">
        ...
        <tr>
          <td height="123" colspan="3" class="style4"><table width="746" border="0" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <td colspan="2" class="style11"><span class="style2">EXIST</span>&nbsp;<input type="text" name="txtf_exist" id="txtf_exist" size="1"  class="style2" value="<%=cant_jv%>" onKeyPress="return handleEnter(this, event)" readonly="true"/>
			...
			while (rset1.next())
	   {
            ...
            <tr>
			  ...
			  <%}%>
              <td colspan="2" class="style11"><input name="Submit" type="submit" class="but" value="Modificar" onChange="setSur1(this.form)" onClick="return existencia0();return verificaN1(document.forms.form); " />&nbsp; <a href="javascript:history.back(1)">Regresar</a></td>
            </tr>
...
<script>
	function existencia0(){
		var existencia = document.getElementById('txtf_exist').value;
		if (existencia === "0"){
			alert("La existencia del medicamento es 0, favor de agragar a su inventario.");
			return false;
		}
	}
</script>
