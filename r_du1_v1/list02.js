...
missinginfo = "";
	...
	{
	missinginfo += "\n - Campo Cantidad Solicitada o Prescripción";
	}			
...
missinginfo = "";
    ...
    if (obj.txtf_sol1.value=="" || obj.txtf_sol1.value==="0")
	{
                          ...
                          //alert(" "+letters);
                           if (year <= 4)
                                 ...
                                 else
                               {
                                  ...
                                  document.form.programa.focus()
                               }
							var dia=parseInt(document.form.txtf_t1a.value);
	                    var mes=parseInt(document.form.txtf_t2a.value);
	                    var anios=parseInt(document.form.txtf_t3a.value);
