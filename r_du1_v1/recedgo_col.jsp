...
if(but.equals("Capturar"))
	...
	stmt.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+tfecha_jv+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+sol1_jv+"','"+sur1_jv+"','"+radiosur_jv+"','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+part_jv+"','"+present1_jv+"','"+resto_jv+"','"+status+"','RC','"+formateador.format(precio_tot)+"','-','-','-','-','"+servicio_jv+"','"+dia+"','-','"+encarser_jv+"','-','-','"+ampuleo+"','-','"+mpio_uni+"','"+formateador.format(precio_clave)+"','"+formateador.format(precio_tot)+"','DURANGO',0)");	
   ...
   if(cant_surpas_amp==cant_pasti_ampu)
	   ...
	   stmt.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+tfecha_jv+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+sol1_jv+"','"+sur1_jv+"','SI','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+part_jv+"','"+present1_jv+"','"+resto_jv+"','"+status+"','RC','"+formateador.format(precio_tot)+"','-','-','-','-','"+servicio_jv+"','"+dia+"','-','"+encarser_jv+"','-','-','"+ampuleo+"','-','"+mpio_uni+"','"+formateador.format(precio_clave)+"','"+formateador.format(precio_tot)+"','DURANGO',0)");
	   //}
	   ...
	   stmt1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_jv+"','"+part_jv+"','-"+sur1_jv+"','"+mtotal+"','"+fechanew+"','"+ela2_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");	   
	   }else{
	  ...
	  */
	  ...
	  if (cant2_o1_jv>0){
	   ...
	   stmt.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+fechanew+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+cant2_o1_jv+"','"+cant2_o1_jv+"','SI','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+partida_o1_jv+"','"+present1_jv+"','0','SURTIDO COMPLETO','RC','"+formateador.format(precio_tot)+"','-','-','-','-','"+servicio_jv+"','"+dia+"','-','"+encarser_jv+"','-','-','-','-','"+mpio_uni+"','"+formateador.format(precio_clave)+"','"+formateador.format(precio_tot)+"','DURANGO',0)");				
					sol2=sol2-cant2_o1_jv;
					stmt1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant2_o1_jv+"','"+partida_o1_jv+"','-"+cant2_o1_jv+"','0','"+fechanew+"','"+ela_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");
	  ...
	  resto_jv=sol2-sur2;
	   ...
	   //--------------------------------Origen 3------------------------------------------------------------------------
		  ...
		  stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_03+"','"+partida_o3_jv+"','"+(-cant2_o3_jv)+"','"+(cant_03-cant2_o3_jv)+"','"+fechanew+"','"+ela_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");
		  }
	   }
	   if (mtotalotsur>0){
		if (cant2_o2_jv>0){
			  ...
			  stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_02+"','"+partida_o2_jv+"','"+(-(cant2_o2_jv))+"','"+((cant_02-cant2_o2_jv))+"','"+fechanew+"','"+ela_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");
			  }
		}	
		...
		//if (cant2_o2_jv>0){
			  ...
			  sol2=sol2-sur_cap;
			  if (sol2>0){
				stmt.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+fechanew+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+sol2+"','0','NO','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','2','"+present1_jv+"','0','PENDIENTE POR SURTIR','RC','"+formateador.format(precio_tot)+"','-','-','-','-','"+servicio_jv+"','"+dia+"','-','"+encarser_jv+"','-','-','-','-','"+mpio_uni+"','"+formateador.format(precio_clave)+"','"+formateador.format(precio_tot)+"','DURANGO',0)");
			  }
  ...
  clave1_jv="";
	...
	stmt.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+tfecha_jv+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+cant2_o1_jv+"','"+cant2_o1_jv+"','SI','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+partida_o1_jv+"','"+present1_jv+"','0','SURTIDO COMPLETO','RC','"+formateador.format(precio_tot)+"','-','-','-','-','"+servicio_jv+"','"+dia+"','-','"+encarser_jv+"','-','-','-','-','"+mpio_uni+"','"+formateador.format(precio_clave)+"','"+formateador.format(precio_tot)+"','DURANGO',0)");				
					...
					stmt1og1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant2_o1_jv+"','"+partida_o1_jv+"','-"+cant2_o1_jv+"','0','"+fechanew+"','"+ela_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");	
	  ...
	  stmt_og22.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+tfecha_jv+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+resto22_jv+"','"+mtotalotsur+"','SI','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+partida_o2_jv+"','"+present1_jv+"','"+resto_jv+"','"+status+"','RC','"+formateador.format(precio_tot)+"','-','-','-','-','"+servicio_jv+"','"+dia+"','-','"+encarser_jv+"','-','-','-','-','"+mpio_uni+"','"+formateador.format(precio_clave)+"','"+formateador.format(precio_tot)+"','DURANGO',0)");	
	  ...
	  stmt1.execute("update inventario set cant='"+mtotalotsur2+"' where clave='"+clave1_jv+"' and origen='"+partida_o2_jv+"'");
	   ...
	   stmt1og2.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant2_o2_jv+"','"+partida_o2_jv+"','-"+mtotalotsur+"','"+mtotalotsur2+"','"+fechanew+"','"+ela_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");	
  ...
  <tr>
    <td width="725" height="156"><table width="801" border="0" align="center" cellpadding="2">
      <tr>
        ...
        RECETA COLECTIVA </span><br /> PACIENTE CAMA</div></td>
      ...
      <table width="763" height="61" border="0" align="center" cellpadding="2">
        <tr>
          <td width="284" height="55"><label></label>
            <table width="270" height="0%" border="0" cellpadding="2">
              <tr>
                <td width="221" height="100%" class="style2">FECHA:<input name="txtf_date" type="text" class="style13" onKeyPress="return handleEnter(this, event)" value="<%=day1%>/<%=res%>/<%= year %>" size="1" readonly style="visibility:hidden"/>
                  &nbsp;
		...
		%>
                <input type="text" name="txtf_foliore" size="20" class="Estilo5"  value="<%=foliore_jv%>" readonly/>
              </label></td>
            </tr>
          </table></td>
        </tr>
...
<option value="CONSULTA EXTERNA">PACIENTE CAMA</option>
...
<option value="YESOS Y CURACIONES">YESOS Y CURACIONES</option>
                </select>&nbsp;Servicio: <input type="text" name="txtf_servicio" class="style2" size="30" value="<%=servicio_jv%>" readonly /></td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
            </tr>
            ...
            <tr>
              ...
              <input name="Submit" type="submit" class="but" value="Clave" onClick="return validaBtnClave();getfocus()"/>&nbsp;<a href="index_carga_clave.jsp" target="_blank">Agregar Clave al Inventario</a> | <a href="inventarios.jsp" target="_blank">Ver Inventario</a></td>
              <td width="59" class="style11">&nbsp;</td>
              <td colspan="2" class="style11"><input type="text" name="txtf_resul" size="20" value="<%=formateador.format(ttcant_surpas_amp2)%>" style="visibility:hidden"/></td>
              <td width="170" class="style11">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2" class="style11">Ingrese descripci&oacute;n: 
                <input type="text" name="txtf_descmed" size="20" value="<%=desdmed_jv%>" onKeyPress="return handleEnter(this, event)" />                <input name="Submit" type="submit" class="but" value="Por Descripción" onClick="return validaBtnDescripcion();getfocus()"/></td>
           ...
           %>
                </select>&nbsp;&nbsp;&nbsp;<input name="Submit" type="submit" class="but" value="Ver" onClick="return validaBtnVer();getfocus()"/></td>
            </tr>
            <tr>
              <td width="91" class="style11"><label> <br />
              </label></td>
              <td width="362" colspan="1" class="style11">&nbsp;</td>
            ...
            <tr>
              ...
              <!--td class="style11" align="center"><span class="style2">Unidades</span></td>
              <td class="style11" align="center"><span class="style2">Horas</span></td>
              <td class="style11" align="center"><span class="style2">D&iacute;as</span></td-->
              <td class="style11" align="center"><span class="style2">CANT. SOL</span></td>
              <td align="center" class="style11"><div align="left"><span class="style2">CANT. SUR</span></div></td>
              <td class="style2" >EXIST.&nbsp;<input type="text" name="txtf_exist" size="1"  class="style2" value="<%=cant_jv%>" onKeyPress="return handleEnter(this, event)" readonly onChange="enViarc(this.form)"/>&nbsp;Origen
                <input name="txtf_part" type="text" class="style2" value="<%=part_jv%>" size="1" readonly /></td>
            </tr>
            <tr>
              <td class="style11"><input type="text" name="txtf_clave1" size="10" value="<%=clave1_jv%>" class="style2"  readonly="true"/>
              <input type="text" name="cant_disp" size="10" class="hidden" value="<%=cant_disp%>"  readonly="true"/>
              </td>
              <td class="style11"><textarea name="txtf_descrip1" cols="80" rows="2" class="style2" readonly><%=descrip1_jv%></textarea></td>
              ...
              <td class="style11" align="center"><input type="text" name="piezas_sol" id="piezas_sol" size="5" class="hidden" />
              <input type="text" name="txtf_sol1" size="5" value="0"  onChange="setSur(this.form)" onKeyPress="return validar(event)" />
              </td>
              <td align="center" class="style11"><div align="left">
...
function sumar() {
    ...
    document.form.txtf_sol1.value = Math.ceil(cajas);
}
</script>
<script type="text/javascript" src="js/validaciones_colectiva.js"></script>
</html>
