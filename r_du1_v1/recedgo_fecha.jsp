...
String org[]= {"1","3","2"};
//array para fuentes
String finan[] = {"SEGURO POPULAR","OPORTUNIDADES","FASSA","ASE","SMNG","Gasto Catastroficos"};
...
try{
		...
		cant_disp=request.getParameter("cant_disp"); 
...
if(but.equals("Capturar"))
	 ...
	 // out.print(var_radio2);
	  ...
	  mtotal=cant2_jv-sur2;
	   ...
	   stmt1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_jv+"','"+part_jv+"','-"+sur1_jv+"','"+mtotal+"','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA FARMACIA','','"+reloj_jv+"','"+foliore_jv+"','"+nomed_jv+"','"+cedu_jv+"','"+nom_unidad+"','-','-',0)");	   
	   }else{
	  ...
	  */
	  ...
	  //stmt.execute("insert into receta values ('"+foliore_jv+"','"+fechanew+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','"+nombre_jv+"','"+edad_jv+"','"+folio_jv+"','"+programa_jv+"','-','"+cedu_jv+"','"+nomed_jv+"','"+cause_jv+"','"+clave1_jv+"','"+descrip1_jv+"','"+cant2_o1_jv+"','"+cant2_o1_jv+"','SI','"+encar_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+partida_o1_jv+"','"+present1_jv+"','0','SURTIDO COMPLETO','RF','-','-','-','-','"+carnet_jv+"','-','"+fechanew+"','A','-','-','-','-','-','-','-','"+corte+"','"+ampuleo+"',0)");	
		...
		stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant2_o1_jv+"','"+partida_o1_jv+"','-"+cant2_o1_jv+"','0','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','"+nomed_jv+"','"+cedu_jv+"','"+nom_unidad+"','-','-',0)");
	   ...
	   */
	   ...
	   //--------------------------------Origen 3------------------------------------------------------------------------
		  ...
		  stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_03+"','"+partida_o3_jv+"','"+(-cant2_o3_jv)+"','"+(cant_03-cant2_o3_jv)+"','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','"+nomed_jv+"','"+cedu_jv+"','"+nom_unidad+"','-','-',0)");
		  }
	   }
	   if (mtotalotsur>0){
		if (cant2_o2_jv>0){
			  ...
			  stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_02+"','"+partida_o2_jv+"','"+(-(cant_02-cant2_o2_jv))+"','"+((cant2_o2_jv))+"','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','"+nomed_jv+"','"+cedu_jv+"','"+nom_unidad+"','-','-',0)");
			  }
		}	
		//if (mtotalotsur>0){
		//if (cant2_o2_jv>0){
	  ...
	  stmt1.execute("update inventario set cant='"+mtotalotsur2+"' where clave='"+clave1_jv+"' and origen='"+partida_o2_jv+"'");
	   ...
	   stmt1og2.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant2_o2_jv+"','"+partida_o2_jv+"','-"+mtotalotsur+"','"+mtotalotsur2+"','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','"+nomed_jv+"','"+cedu_jv+"','"+nom_unidad+"','-','-',0)");	
...
if(but.equals("Imprimir"))
     {
	  ...
	  %>
	  <script>
	  self.location='recibo_farm_fecha.jsp?var_radio1=<%=radiopro_jv%>&folio=<%=foliore2_jv%>&receta5=RF&encar=<%=encar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=<%=part_jv%>&id_med=<%=id_med_jv%>&perfil=<%=perfil%>';
...
<form name="form" method="post" onsubmit="return checkSubmit();" action="recedgo_fecha.jsp?var_radio1=<%=radiopro_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&nombre=<%=nombre_jv%>&edad=<%=edad_jv%>&folio=<%=folio_jv%>&clave1=<%=clave1_jv%>&descrip1=<%=descrip1_jv%>&present1=<%=present1_jv%>&indica1=<%=indica1_jv%>&sol1=<%=sol1_jv%>&sur1=<%=sur1_jv%>&cause=<%=cause_jv%>&foliore=<%=foliore_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&univer=<%=uni_jv%>&cedu=<%=cedu_jv%>&nomed=<%=nomed_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&programa=<%=programa_jv%>&perfil=<%=perfil%>">
      ...
      <table width="854" height="45" border="0" align="center" cellpadding="2">
          ...
          <td width="311" height="41">
            <table width="270" height="0%" border="0" cellpadding="2">
              <tr>
                ...
                <input name="txtf_date1" type="text" size="20" value="<%= day1 %>/<%=res%>/<%= year %>" onKeyUp="putFecha(this.form)" onKeyPress="return handleEnter(this, event)" readonly/>
				<input name="txtf_t1" value="1" class="hidden" />
				<input name="txtf_t2" value="1" class="hidden" />
				</td>
              </tr>
          </table>          </td>
		...
		%>
           ...
           %>
             ...
             <a href="renovacion.jsp?folio_sp=<%=folio_sp%>" target="popup"
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO PATERNO <span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO MATERNO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NOMBRE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></label></td>
              <td width="139"><table width="137" border="0" align="right" cellpadding="2">
                <tr>
                  <td width="129"><div align="left"><span class="style2">
                    <input name="txtf_edad" type="text" onkeyUp="return ValNumero(this);" maxlength="3" class="style13" value="<%=edad_jv%>" size="5"  onKeyPress="return handleEnter(this, event)"/>
                    <br />
                    EDAD</span></div></td>
                </tr>
              </table></td>
        ...
        <tr>
          <td height="82" colspan="3" onkeyUp="return ValNumero(this);" maxlength="3" class="style4"><table width="733" border="0" align="center" cellpadding="2">
            <tr>
        ...
        <tr>
          <td height="38" colspan="3" class="style4"><table width="763" border="0" align="center" cellpadding="2">
            <tr>
              <td width="755" class="style2"><a href="medico.jsp" target="_blank">NUEVO MÉDICO</a> | CÉDULA: 
                <input name="txtf_medico" type="text" size="10"  onchange="<%=but2="Medico"%>" onKeyPress="return handleEnter(this, event)" /><input name="Submit" type="submit" class="subHeader" value="Médico" onClick=" return validaBtnMedico();" />
              NOMBRE:
              <input name="txtf_nomed" id="txtf_nomed" type="text" onkeypress="return handleEnter(this, event);return soloLetras(event);" onfocusout="this.value=this.value.toUpperCase()" class="style13" value="<%=nomed_jv%>" size="35" />
        ...
        <tr>
          <td height="219" colspan="3" class="style4"><table width="875" border="0" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <input type="text" name="txtf_med1" id="txtf_med1" size="10" value="<%=med1_jv%>"  onkeypress="return handleEnter(this, event)"/><input name="Submit" type="submit" class="subHeader" value="Clave" onClick="return validaBtnClave(); habilitaBoton();" />
              &nbsp;<a href="index_carga_clave.jsp" target="_blank">Agregar Clave al Inventario </a> | <a href="inventarios.jsp" target="_blank">Ver Inventario</a></td>
               <td colspan="6" class="style11"><span class="style2"><span class="Estilo8">TOTAL EXISTENCIAS:</span><span class="Estilo5"> <%=sumatotal%>&nbsp;</span></span></td>
            ...
            <tr>
              ...
              <td width="59" class="style11"><span class="hidden">SUR</span></td>
            ...
            <tr>
              ...
              <input name="Submit" type="submit" id="capturaid" class="but" value="Capturar" onClick="return verificaN_Fa(document.forms.form);" onChange="setSur(this.form)" />
			    ...
			    %>
					...
					<input type="submit" name="corte" id="corteid" class="but" onclick="bloquea(this.form)" value="Corte" />
  ...
  %>
	  ...
	  %>
              <td class="style11" colspan="3"><input  type="button" id="btn_<%=eliminar_jv%>" name="btn_<%=eliminar_jv%>" class="subHeader" value="Eliminar" onclick='location.href="eliminar_fecha.jsp?var_radio1=<%=radiopro_jv%>&id_prov=<%=eliminar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&nombre=<%=nombre_jv%>&edad=<%=edad_jv%>&folio=<%=folio_jv%>&clave1=<%=clave1_jv%>&descrip1=<%=descrip1_jv%>&present1=<%=present1_jv%>&indica1=<%=indica1_jv%>&sol1=<%=sol1_jv%>&sur1=<%=sur1_jv%>&clave2=<%=clave2_jv%>&descrip2=<%=descrip2_jv%>&present2=<%=present2_jv%>&indica2=<%=indica2_jv%>&sol2=<%=sol2_jv%>&sur2=<%=sur2_jv%>&clave3=<%=clave3_jv%>&descrip3=<%=descrip3_jv%>&present3=<%=present3_jv%>&indica3=<%=indica3_jv%>&sol3=<%=sol3_jv%>&sur3=<%=sur3_jv%>&cause=<%=cause_jv%>&foliore=<%=foliore_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&univer=<%=uni_jv%>&cedu=<%=cedu_jv%>&nomed=<%=nomed_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=<%=part_jv%>&id_med=<%=id_med_jv%>&day5=<%=t1_jv%>&carnet=<%=carnet_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&programa=<%=programa_jv%>&perfil=<%=perfil%>"'/>&nbsp;<input  type="button" id="btn_<%=eliminar_jv%>2" name="btn_<%=eliminar_jv%>2" class="subHeader" value="Modificar" onclick='location.href="modificar_new_fecha.jsp?radio_pro=<%=radiopro_jv%>&id_prov=<%=eliminar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&nombre=<%=nombre_jv%>&edad=<%=edad_jv%>&folio=<%=folio_jv%>&clave1=<%=clave1_jv%>&descrip1=<%=descrip1_jv%>&present1=<%=present1_jv%>&indica1=<%=indica1_jv%>&sol1=<%=sol1_jv%>&sur1=<%=sur1_jv%>&clave2=<%=clave2_jv%>&descrip2=<%=descrip2_jv%>&present2=<%=present2_jv%>&indica2=<%=indica2_jv%>&sol2=<%=sol2_jv%>&sur2=<%=sur2_jv%>&clave3=<%=clave3_jv%>&descrip3=<%=descrip3_jv%>&present3=<%=present3_jv%>&indica3=<%=indica3_jv%>&sol3=<%=sol3_jv%>&sur3=<%=sur3_jv%>&cause=<%=cause_jv%>&foliore=<%=foliore_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&univer=<%=uni_jv%>&cedu=<%=cedu_jv%>&nomed=<%=nomed_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=<%=part_jv%>&id_med=<%=id_med_jv%>&day5=<%=t1_jv%>&carnet=<%=carnet_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&programa=<%=programa_jv%>&perfil=<%=perfil%>"'/></td>
            </tr>
			<%
			}
			%>
