...
<%
String t1a_jv="",t2a_jv="",t3a_jv="",t1b_jv="",t2b_jv="",t3b_jv="",t1c_jv="",t2c_jv="",t3c_jv="",nom_jv="",ap_jv="",am_jv="",fechana="",fechaini="",fechafin="",nombre1_jv="";
String but="r";
String noaf_jv="";
long folsp=0;
...
Calendar fecha = new GregorianCalendar();
        ...
        aniona = Integer.parseInt(t3a_jv);
    ...
    <tr>
      <td width="731"><table width="650" height="478" border="0" align="center" cellpadding="2">
        ...
        <tr>
          ...
          <td><input maxlength="16"  name="txtf_noaf" type="text" onkeyUp="return ValNumero(this);" id="txtf_noaf" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <th height="26" scope="row">&nbsp;</th>
          ...
          <td><span class="bodyText"><span class="style5">
            <input name="txtf_nom" type="text" id="txtf_nom" onKeyPress="return soloLetras(event);return handleEnter(this, event)" onChange="mayNom(this.form)"/>
          </span></span></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><span class="bodyText"><span class="style5">
            <input name="txtf_ap" type="text" id="txtf_ap" onKeyPress="return soloLetras(event);return handleEnter(this, event)" onChange="mayApep(this.form)"/>
          </span></span></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><span class="bodyText"><span class="style5">
            <input name="txtf_am" type="text" id="txtf_am" onKeyPress="return soloLetras(event);return handleEnter(this, event)" onChange="mayApem(this.form)"/>
          </span></span></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><input name="txtf_edad" type="text" readonly="readonly"  id="txtf_edad"   onKeyPress="return handleEnter(this, event)" /></td>
            <strong></strong>
          <td>&nbsp;</td>
        </tr> 
        <tr>
