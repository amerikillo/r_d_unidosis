...
if(but.equals("Capturar"))
	 ...
	 ptotal=precio2*sur2;
	  ...
	  mtotal=cant2_jv-sur2;
	   ...
	   stmt1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_jv+"','"+part_jv+"','-"+sur1_jv+"','"+mtotal+"','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','"+nomed_jv+"','"+cedu_jv+"','"+nom_unidad+"','-','-',0)");	 
        ...
        <tr>
          <td height="219" colspan="3" class="style4"><table width="779" border="0" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <input type="text" name="txtf_med1" size="10" value="<%=med1_jv%>"  onkeypress="return handleEnter(this, event)"/><input name="Submit" type="submit" class="subHeader" value="Clave" /><a href="index_carga_clave.jsp" target="_blank">Agregar Clave al Inventario</a> | <a href="inventarios.jsp" target="_blank">Ver Inventario</a></td>
