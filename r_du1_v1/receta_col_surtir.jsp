	  ...
	  while(rset1.next())
				  ...
				  ResultSet rset_date = stmt_date.executeQuery("SELECT DATE_FORMAT('"+t3_jv+"', '%d/%m/%Y')"); //;SELECT STR_TO_DATE('"+date_jv+"', '%m/%d/%Y')
                    ...
                    t3_jv= rset_date.getString("DATE_FORMAT('"+t3_jv+"', '%d/%m/%Y')");//STR_TO_DATE('"+date_jv+"', '%m/%d/%Y')
					 ...
					 encarser_jv=rset1.getString("tipo_unidad");
					 }
          ...
          <td width="276" align="center" class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FECHA
            ...
            <tr>
              <td width="222" height="100%"><label>
                <input type='text' name='txtf_t3' id='txtf_t3' title='DD/MM/AAAA' value="<%=t3_jv%>" size='10' maxlength='10' onclick='scwShow(this, event);' readonly class="style1"/>
...
<option value="YESOS Y CURACIONES">YESOS Y CURACIONES</option>
            ...
            <tr>
              <td colspan="3" class="style2">Encargado del Servicio: <input type="text" name="txtf_encarser" class="style2" size="60" value="<%=encarser_jv%>" readonly/></td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
            </tr>
            <tr>
              ...
              <input name="Submit" type="submit" class="but" value="Clave" onClick="getfocus()"/>&nbsp;<a href="index_carga_clave.jsp" target="_blank">Agregar Clave al Inventario</a> | <a href="inventarios.jsp" target="_blank">Ver Inventario</a></td>
