...
conn__001 = DriverManager.getConnection("jdbc:mysql://localhost/r_d_unidosis", "root", "eve9397");
...
<table width="450" cellpadding="3" cellspacing="1" border="2" >
    ...
    <tr height="20">
    <td height="20" colspan="6" style="border:double"><p align="center">EXISTENCIAS INVENTARIO UNIDAD</p>
      <p align="center">PACIENTE CAMA  </p></td>
  </tr>
  ...
  <tr height="20">
    ...
    <td width="41"   style="border:double">PRESENTACION</td>
    <td width="28"   style="border:double">PIEZAS</td>
  ...
  <%
    ...
    <td  style="border:double"><div align="center" class="Estilo7">
      <%out.print(cant_ps_jv);%>
    </div></td>
		  
    <td  style="border:double"><span class="Estilo7"><%=rset__001.getString("cant")%>    </span></td>
