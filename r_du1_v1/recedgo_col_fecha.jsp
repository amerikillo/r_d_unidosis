...
if(but.equals("Capturar"))
   ...
   if(cant_surpas_amp==cant_pasti_ampu)
	  ...
	  // }
	   ...
	   stmt1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_jv+"','"+part_jv+"','-"+sur1_jv+"','"+mtotal+"','"+fechanew+"','"+ela2_jv+"','SALIDA VÍA RECETA COLECTIVA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");	   
	   }else{
  ...
  <tr>
    <td width="725" height="156"><table width="710" border="0" align="center" cellpadding="2">
      <tr>
        ...
        RECETA COLECTIVA<br />PACIENTE CAMA </span></div></td>
...
<option value="PACIENTE EN CAMA">PACIENTE EN CAMA</option>
            ...
            <tr>
              <td colspan="6" class="style11">Seleccione Descripci&oacute;n:
                <select name="select_servi2" size="1"  class="style2"  onKeyPress="return document.form.txtf_med1.focus();">
                              <option selected="selected" value="">-----Seleccione Descripción-----</option>
							  <%
