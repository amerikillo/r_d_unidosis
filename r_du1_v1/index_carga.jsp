...
<% Class.forName("org.gjt.mm.mysql.Driver");
     ...
     String arr[]= new String[5000];     //array for the 
	  ...
	  ResultSet rset_8 = null;
	  Statement stmt_8 = null;
...
{
          conn_2 = DriverManager.getConnection("jdbc:mysql://localhost/r_d_unidosis", "root", "eve9397");
	  ...
	  stmt_6cargas = conn_2.createStatement();
		...
		rset_8=stmt_8.executeQuery("select unidad from receta");
		while (rset_8.next()){
				unidad=rset_8.getString("unidad");
		}
		//out.print(unidad);
...
<%
 	...
 	Date dNow = new Date();
        ...
        String currentDate = ft.format(dNow);					
							 ...
							 stmt_ruta.execute("insert into receta_carga_archivos values ('"+ruta22+"','"+currentDate+"')");
 ...
 rset_2=stmt_3.executeQuery("select clave,origen,descrip,lote,caducidad,sum(cant),origen from inventario_carga group by (clave),origen;");
         ...
         rset_ruta=stmt_ruta.executeQuery("select clave,cant from pasti_ampu where clave='"+clave+"' group by clave;");
                 ...
                 rset_4=stmt_4.executeQuery("select clave,descrip,lote,caducidad,sum(cant),origen from inventario_carga where clave='"+clave+"' and origen='"+origen+"' group by clave;");
								...
								stmt_6carga.execute("insert into modificacion values('"+clave2+"','"+descrip2+"','"+lote2+"','"+caducidad2+"',"+totalnew+",'"+origen2+"',"+totalp+",'"+mtotal2+"','"+fecha_modi+"','"+usuario+"','INCREMENTO CARGA INVENTARIO','',current_timestamp,'-','-','-','"+unidad+"','-','-',0)");
				 ...
				 totalnew=0;
                                         ...
                                         stmt_555s.execute("delete from inventario where clave='"+clave+"' and origen='"+origen+"';");	
                                                 ...
                                                 stmt_6carga.execute("insert into inventario values ('"+clave2+"','"+descrip2+"','"+lote2+"','"+caducidad2+"','"+mtotal2+"','"+origen2+"')");
                                                 stmt_6cargas.execute("insert into modificacion values('"+clave2+"','"+descrip2+"','"+lote2+"','"+caducidad2+"',"+totalnew+",'"+origen2+"',"+total2+",'"+mtotal2+"','"+fecha_modi+"','"+usuario+"','INCREMENTO CARGA INVENTARIO','',current_timestamp,'-','-','-','"+unidad+"','-','-',0)");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#C0DFFD" onload="fillCategory_uni()">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr bgcolor="" >
                <td height="44" colspan="3" align="center" valign="top" style="background-color:#FFFFFF; color:#000000" ><div align="center" ><br /> <h3>PACIENTE EN CAMA</h3>	</div>
            </tr>
