...
String t1a_jv="",t2a_jv="",t3a_jv="",t1b_jv="",t2b_jv="",t3b_jv="",t1c_jv="",t2c_jv="",t3c_jv="",noaf_jv="",nom_jv="",ap_jv="",am_jv="",fechana="",fechaini="",fechafin="",nombre1_jv="", edad="";
String hora_ini_jv="";
String lugar_jv="";
...
try{
		...
		nomed_jv=request.getParameter("nomed");
                folio_sp=request.getParameter("folio_sp");
...
if(but.equals("Guardar"))
     {
         folio_jv=request.getParameter("txtf_cb"); 
	 ...
	 edad=request.getParameter("txtf_t3a");
...
<table width="703" border="0">
  <tr>
    <th width="196" bgcolor="#CCCCCC" class="azul" scope="col"><div align="left"><u><span class="style7"> C&oacute;digo del  Paciente:</span></u></div></th>
    <th width="242" bgcolor="#CCCCCC" class="left" scope="col"><span class="style7">
            <input readonly="readonly" name="txtf_cb" type="text" id="txtf_cb" value="<%=folio_sp%>"  onchange="<%=but="Mostrar"%>" />
