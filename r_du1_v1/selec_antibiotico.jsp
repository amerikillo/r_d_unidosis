    ...
    <td width="650"><form id="form" name="form" method="post" action="index_movi2.jsp">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        <tr>
          ...
          <td height="49" colspan="2" bgcolor="#FFFFFF" class="logo style1"><div align="center">Men&uacute; Impresi&oacute;n de Reporte de Antibioticos</div></td>
        ...
        <tr>
          ...
          <td colspan="2" class="style5"><label><a href="antibioticos_farmacia.jsp">REPORTE ANTIBIOTICOS RECETA POR FARMACIA</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="2" class="style5"><label><a href="antibioticos_colectiva.jsp">REPORTE ANTIBIOTICOS RECETA COLECTIVA</a> </label></td>
          <td>&nbsp;</td>
        </tr>
