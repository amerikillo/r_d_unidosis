...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
	...
	{
 rset__001=stmt__001.executeQuery("select fecha_re,folio_re,nombre_medi,cedula_medi,clave,descrip,cant_sol,cant_sur,ampuleo from receta where pendientes not in ('T') and unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+org_jv+"' and tipo_receta='rf' order by (fecha_re),folio_re asc");
...
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#CCFF99">
      ...
      <a href="antibioticos_farmacia.jsp" class="style76"><span class="Estilo1">Regresar a Menú</span></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Estilo1">ORIGEN "<%=org1_jv%>"</span></td>
  </tr>
 <tr>
    <td colspan="7" bgcolor="#003366"><img src="mm_spacer.gif" alt="" width="1" height="1" border="0" /></td>
  </tr>
 ...
 <tr>
    ...
    <table width="718" border="0" align="center">
      <tr>
        <td width="518"><table width="712" border="1">
            <tr>
              <td width="161" ><span class="style49">Fecha</span></td>
              <td width="33"> <span class="style49">Folio</span></td>
              
              
              <td width="259"> <span class="style49">Nombre M&eacute;dico </span></td>
              <td width="50"> <span class="style49">Cedula</span></td>
              <td width="56"> <span class="style49">Clave Articulo </span></td>
              <td width="193"> <span class="style49">Descripci&oacute;n</span></td>
              
         
              
              <td width="44"> <span class="style49">Piezas</span></td>
    ...
    while(rset__001.next()) 
				  ...
				  sur=rset__001.getString("cant_sur");
				  //out.print(clave);
				  //out.print(clave_anti);
				  ...
				  while(rset__002.next()){	
						 ...
						 clave_anti= rset__002.getString("clave");
						  ...
						  sur1=sur1+Integer.parseInt(sur);
						  //out.print(clave_anti);
								%>
										<tr>
			...
			/*rset_1=stmt__001.executeQuery("select sum(cant_sol),sum(cant_sur) from receta where pendientes not in ('T') and unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+org_jv+"' and tipo_receta='rf'");
			while(rset_1.next()) 
                  {
			...
			rset_2=stmt__002.executeQuery("select count(folio_re) from receta where pendientes not in ('T') and unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+org_jv+"' and tipo_receta='rf' group by folio_re");
			while(rset_2.next()) 
                  {
				  folio_re2++;
