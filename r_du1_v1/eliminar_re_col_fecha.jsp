...
//	String ela_jv="",id_med_jv="",cant_jv="",cv_finan_jv="",financiamiento1="",layout="",part_jv="",resto_jv="",status="";					
	  ...
	  servicio_jv=rset_re.getString("txtf_servicio");*/
			...
			stmt1.execute("insert into modificacion values ('"+clavesur+"','"+descripsur+"','-','-','"+cantinv2+"','"+partidasur+"','"+cant2_jv+"','"+mtotal+"','"+date+"','"+ela2_jv+"','AJUSTE VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");
			}
			else{
			stmt_inv2.execute("insert into inventario values ('"+clavesur+"','"+descripsur+"','-','-','"+cant2_jv+"','"+partidasur+"')");
			stmt1.execute("insert into modificacion values ('"+clavesur+"','"+descripsur+"','-','-','0','"+partidasur+"','"+cant2_jv+"','"+mtotal+"','"+date+"','"+ela2_jv+"','AJUSTE VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");
			}
