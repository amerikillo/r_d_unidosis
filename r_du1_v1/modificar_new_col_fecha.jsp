			  ...
			  date_jv=request.getParameter("txtf_date1");
			   ...
			   rset_re = stmt_re.executeQuery(" select * from receta_colectiva WHERE id='"+eliminar_jv+"'");
				  ...
				  descrip1_jv=rset_re.getString("descrip");
					...
					encarser_jv=rset_re.getString("tipo_unidad");
					}
						...
						/*			*/
						   ...
						   //if(cantinv2>0)
							 // {
									...
									stmt1.execute("insert into modificacion values ('"+clavesur+"','"+descripsur+"','-','-','"+cantinv2+"','"+partidasur+"','-"+mtotal+"','"+mtotal2+"','"+date_jv+"','"+ela2_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");
									}else{
									mtotal=cant22_jv-sur11;
									mtotal2=mtotal+cantinv2;
									stmt1.execute("insert into modificacion values ('"+clavesur+"','"+descripsur+"','-','-','"+cantinv2+"','"+partidasur+"','"+mtotal+"','"+mtotal2+"','"+date_jv+"','"+ela2_jv+"','AJUSTE VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','"+nom_unidad+"','-','-',0)");
									}
									//out.print(""+mtotal2);
