...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
		...
		if(boton_jv.equals("Show ALL"))
	{
       ...
       rset__001=stmt__001.executeQuery("select clave,cant_anterior,cant_mov,cant_actual,fecha,status,folio,medico,cedula,unidad from modificacion where unidad='"+llamo_cat_jv+"' and clave='"+clave_antibiotico+"' and fecha between '"+date1_jv+"' and '"+date2_jv+"'");
	}
...
<table width="618" border="0" align="center" cellpadding="2">
  <tr>
    ...
    <td height="63" colspan="2" align="center" valign="bottom" nowrap="nowrap" id="logo"><div align="center">
     <span  style="color:#190707"> GOBIERNO DEL ESTADO DE DURANGO<br />
      SECRETARIA DE SALUD</br>
	  TIENDAS SORIANA S.A DE C.V<br />
	  REPORTE DE ANTIBIOTICOS <br />
    DE LA UNIDAD: <%=llamo_cat_jv%><br />
    PERIODO: <%=date1_jv%> al <%=date2_jv%><br /> PACIENTE EN CAMA<br /></span>
...
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	<td align="right">Exportar</span>&nbsp;<img src="icono_excel.gif" border="0" usemap="#Map2"/></td>
  </tr>
  <tr>
  ...
  <tr bgcolor="#CCFF99">
      ...
      <a href="antibioticos_farmacia.jsp" class="style76"><span class="Estilo1">Regresar a Menú</span></a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Estilo1">REPORTE DE ANTIBIOTICOS</span></td>
  </tr>
 <tr>
    <td colspan="7" bgcolor="#003366"><img src="mm_spacer.gif" alt="" width="1" height="1" border="0" /></td>
  </tr>
 ...
 <tr>
    ...
    <td colspan="7" valign="top"><form action="antibioticos_far.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
    <table width="67%" border="0">
      <tr>
        <td width="818"><table width="150%" border="1">
            <tr bgcolor="#2CACAD">
			  <td width="100" align="center"><span class="Estilo1"><strong>Fecha Entrada</strong></span></td>
              <td width="100" align="center"><span class="Estilo1"><strong>Fecha Salida</strong></span></td>
			  ...
			  <td width="200" align="center"> <span class="Estilo1"><strong>domicilio</strong></span></td>
              ...
              <td width="44" align="center"> <span class="Estilo1"><strong>Entrada</strong></span></td>
              <td width="44" align="center"> <span class="Estilo1"><strong>Salida</strong></span></td>
						...
						while(rset__002.next()) 
                             {		
									...
									if (clave.equals(clave_anti)){
												if (estatus.equals("INCREMENTO CARGA INVENTARIO") || estatus.equals("AJUSTE VÍA RECETA") || estatus.equals("ENTRADA MANUAL AL INVENTARIO")){
													   %> 		
															<tr>
																...
																<td><span class="style49"><%=estatus%></span></span></td>
															</tr>
...
<map name="Map2" id="Map2">
  <area shape="rect" coords="6,5,33,31" href="antibioticos_excel.jsp?clave=<%=clave_antibiotico%>&f1=<%=date11_jv%>&f2=<%=date22_jv%>&boton=Show ALL&unidad=<%=llamo_cat_jv%>" />
</map>
</body>
</html>
